<form method="POST" style="margin-top:50px" class="corpo_login">  
  ...
  <div class="form-group">
    <label for="data" id="data">Data do lançamento:</label>
...
<script type="text/javascript" src="<?php echo BASE_URL; ?>models/jQuery/cadastro_lancamento_recebimento.js"></script>
