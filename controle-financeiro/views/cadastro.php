...
<html>
    ...
    <body>
    <h2 style="text-align:center;margin-top:60px;margin-bottom:30px">Cadastre-se!</h2>
<form method="POST" style="text-align:center" class="corpo_login">  
  ...
  ?>
  <button type="submit" class="btn btn-primary" style="margin-top:20px;width:150px">Cadastrar</button>
