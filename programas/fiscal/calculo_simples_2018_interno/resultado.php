			...
			<?php
				...
				try{
					...
					foreach ($_SESSION['categorias'] as $categoria) {
						...
						echo 	"Anexo ".$categoria_parametros['anexo']." - ".utf8_encode($categoria_parametros['nome']).":<br/>";
						echo "</div>";
						...
						//Cálculo com fator R
						if(isset($_SESSION['atividade'][$categoria]) && !empty($_SESSION['atividade'][$categoria])){
