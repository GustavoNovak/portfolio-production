			...
			<div class="formulario">
				...
				<div class="formulario_usuario">
					<form name="form_cadastro" method="POST" action="cadastro_informacao.php">
						...
						<input type="text" name="user_name" placeholder="Nome de usuário" autocomplete="off" minlength="4" maxlength="15" autofocus required/><br/><br/>

						<input type="password" name="password" placeholder="Senha" minlength="8" autocomplete="off" required/><br/><br/>
